...
export default {
  ...
  methods: {
    onLoad() {
      ...
      //     }
      //   }, 500);
      axios.get("http://api.jinxing.kfs.dev.anjuke.test/apis/housework/collectList/",{
            params:{
                user_id:10
            },
        })
    ...
    // $.ajax({
    //     url:'http://api.jinxing.kfs.dev.anjuke.test/apis/housework/collectList/',
    //     type:'get',
    //     dataType:'jsonp'
    // }).done(function(data){
    //     console.log(data);
    ...
    //     console.log('error')
    // })
    // this.$jsonp('http://api.jinxing.kfs.dev.anjuke.test/apis/housework/collectList/',{user_id:10})
    // .then(json=>{
    //     console.log(json)
    // })
    // .catch(err=>{
